...
const SchedulesLive = () => {
  ...
  const schedulerName =
    urlParams.get("schedulerName") || load("liveSchedulerName", undefined);
  const scheduleId =
    urlParams.get("scheduleId") || load("liveScheduleId", undefined);
  const epochFrom =
    urlParams.get("epochFrom") || load("liveEpochFrom", undefined);
